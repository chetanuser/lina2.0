...
from linarobo import SUPPORT_CHAT, pbot,BOT_USERNAME, OWNER_ID
...
lol = "https://te.legra.ph/file/5f3b5901d1ccc014dca9c.jpg"
...
async def restart(client, m: Message):
    ...
    await m.reply_photo(
        lol,
        caption=f"""**🌷ʜᴇʏ, ɪ ᴀᴍ 『[LINA](f"t.me/{BOT_USERNAME}")』🎄**
   ╔═════ஜ۩۞۩ஜ════╗
