...
import linarobo.modules.sql.userinfo_sql as sql
...
from linarobo import telethn as MukeshTelethonClient
from linarobo.__main__ import STATS, TOKEN, USER_INFO
from linarobo.modules.disable import DisableAbleCommandHandler
from linarobo.modules.helper_funcs.chat_status import sudo_plus
from linarobo.modules.helper_funcs.extraction import extract_user
from linarobo.modules.sql.afk_sql import check_afk_status, is_afk
from linarobo.modules.sql.global_bans_sql import is_user_gbanned
from linarobo.modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ᴅᴇᴠᴇʟᴏᴘᴇʀ", url="https://t.me/thanosceo"
                            ),
                            InlineKeyboardButton(
                                "Dɪsᴀsᴛᴇʀ", url="https://t.me/thanos_pro"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/thanos_pro"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
