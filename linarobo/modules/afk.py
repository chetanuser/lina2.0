...
from linarobo import dispatcher,OWNER_ID
from linarobo.modules.disable import (
    DisableAbleCommandHandler,
    DisableAbleMessageHandler,
)
from linarobo.modules.sql import afk_sql as sql
from linarobo.modules.users import get_user_id
