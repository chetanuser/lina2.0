...
# from linarobo.modules.sql import warns_sql as warnssql
import linarobo.modules.sql.blacklist_sql as blacklistsql

# from linarobo.modules.sql import cust_filters_sql as filtersql
# import linarobo.modules.sql.welcome_sql as welcsql
import linarobo.modules.sql.locks_sql as locksql
import linarobo.modules.sql.notes_sql as sql

# from linarobo.modules.rules import get_rules
import linarobo.modules.sql.rules_sql as rulessql
from linarobo import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from linarobo.__main__ import DATA_IMPORT
from linarobo.modules.connection import connected
from linarobo.modules.helper_funcs.alternate import typing_action
from linarobo.modules.helper_funcs.chat_status import user_admin
from linarobo.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("linarobo{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("linarobo{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `linarobo-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("linarobo{}.backup".format(chat_id))  # Cleaning file
